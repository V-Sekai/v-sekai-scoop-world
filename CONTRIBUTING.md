...
- **Godot manifest**: The installer script downloads templates and symbols; update `$release_version` and the three SHA256 variables in the script when upgrading the editor release.
